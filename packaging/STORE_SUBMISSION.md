...
must differ too. As of 2026-09-13 the Store carries **1.0.33**, the newest published
sideload package is **v1.0.28-beta**, and **1.0.30-beta** and **1.0.32-beta**
(both signed) are built and published on neither channel - so
the next change on either channel takes 1.0.34 or later. Note that 1.0.32-beta and
1.0.33 are the same SOURCE and different BUILDS, which is exactly why they carry
