...
//
// A consequence used to be worth naming here: tools/check-shipped-disks.sh
// matched the quoted vX.Y.Z above with a regex, so with the constant gone it
// printed NO PIN FOUND and exited 1 for a client that was working correctly.
// That script was deleted from all four ports on 2026-09-13, so nothing greps
// this file for a pin any more and no formatting here is owed to it.
